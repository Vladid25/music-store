        ...
        <div class="mb-12 space-y-2">
            <?php $__currentLoopData = $exception->frames(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div x-show="! includeVendorFrames">
                        <?php if($vendorFramesCollapsed->isNotEmpty()): ?>
                            <div class="text-gray-500">
                                <?php echo e($vendorFramesCollapsed->count(), false); ?> vendor frame<?php echo e($vendorFramesCollapsed->count() > 1 ? 's' : '', false); ?> collapsed
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                ...
                <button
                    ...
                    x-show="<?php echo e($frame->isFromVendor() ? 'includeVendorFrames' : 'true', false); ?>"
                    @click="index = <?php echo e($loop->index, false); ?>"
                >
                    <div
                        x-bind:class="
                            index === <?php echo e($loop->index, false); ?>
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300"><?php echo e($frame->source(), false); ?></span>
                                    <span class="font-mono text-xs">:<?php echo e($frame->line(), false); ?></span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                <?php echo e($exception->frames()->get($loop->index + 1)?->callable(), false); ?>
                ...
                <?php if(! $frame->isFromVendor() && $exception->frames()->slice($loop->index + 1)->filter(fn ($frame) => ! $frame->isFromVendor())->isEmpty()): ?>
                    <?php if($exception->frames()->slice($loop->index + 1)->count()): ?>
                        <div x-show="! includeVendorFrames">
                            <div class="text-gray-500">
                                <?php echo e($exception->frames()->slice($loop->index + 1)->count(), false); ?> vendor
                                frame<?php echo e($exception->frames()->slice($loop->index + 1)->count() > 1 ? 's' : '', false); ?> collapsed
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
