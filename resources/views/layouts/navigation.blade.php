        ...
        <div class="flex justify-between h-16 items-center">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="hover:text-blue-600 transition duration-300">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="relative">
                <a href="{{ route('cart.index') }}" class="text-gray-600 hover:text-blue-600 transition duration-300 relative">
                    ...
                    @if(Session::has('cart'))
                        ...
                        @endphp
                        <span class="absolute top-0 right-0 bg-red-600 text-white text-xs font-bold rounded-full px-1">{{ $totalItems }}</span>
                    @endif
                </a>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-blue-600 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div>
